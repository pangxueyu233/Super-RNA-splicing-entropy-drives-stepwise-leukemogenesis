...
~~~R
scRNA_leukemogenesis_all <- mcreadRDS("./scAML_project/sc-RNAseq/mmu_10X_scRNA_Landscape_of_leukemogenesis_all.rds",mc.cores=20)
...
tipping_point <- mcreadRDS(file="./scAML_project/sc-RNAseq/mmu_10X_scRNA_Landscape_of_leukemogenesis_tipping_point.rds", mc.cores=20)
...
ggsave("./new_figure_v2/new_figure/ALL_interested_umap.png", plot=p1,width = 6, height = 5,dpi=1080)
...
ggsave("./new_figure_v2/new_figure/ALL_interested_umap_by_group.png", plot=p1,width = 20, height = 5,dpi=1080)
~~~
...
ggsave("./v1_Figure/supplemental_ALL_ratio_alter.svg", plot=aa,width = 18, height = 3,dpi=1080)
~~~
...
write.csv(scRNA_leukemogenesis_all_markers,"./v2_results/scRNA_leukemogenesis_all_markers.csv")

AML_markers <- read.csv("./v2_results/scRNA_leukemogenesis_all_markers.csv")
...
~~~R
PLC_10X_scRNA <- mcreadRDS(file="./scAML_project/sc-RNAseq/mmu_10X_scRNA_Landscape_of_leukemogenesis_PLC.rds", mc.cores=20)
require(pheatmap)
require(ComplexHeatmap)
require(BuenColors)
require(scales) 
New_T00_obj.markers <- readRDS(file="./figure/Fig_New_T00_obj.markers.rds")
...
Myc_targets <- read.csv(file="./v2_results/MYC_TARGETS.csv")
...
ggsave("./new_figure_v2/new_figure/Stemnessand_difff_score.svg", plot=sp1,width = 15, height = 4,dpi=1080)
~~~

![image-20210609184655106](scRNA_analysis.assets/image-20210609184655106.png)

~~~R
cc.genes <- readRDS("./DATABASE/mouse_cell_cycle_genes.rds")
...
sp1 <- sp + stat_density_2d(aes(fill = ..level..), geom="polygon")+theme_classic() +xlim(-2.5,2.5)+ylim(-3,3)+
    scale_fill_gradientn(colours=alpha(aa,0.6),na.value="NA") + facet_wrap(~new_group,ncol=4) + labs(title="ALL only netro lineages in GFP P cells")
ggsave("./new_figure_v2/new_figure/cell_cycle_score.svg", plot=sp1,width = 15, height = 4,dpi=1080)
~~~
...
ggsave("./new_figure_v2/new_figure/MYC_TARGETS_PLC_KEGG.svg", plot=aa,width = 5, height = 3,dpi=1080)
~~~
...
~~~R
nmat <- mcreadRDS("./scAML_project/sc-RNAseq/mmu_10X_scRNA_Landscape_of_leukemogenesis_all_unspliced.rds", mc.cores=20)
...
write.csv(only_tip_seuratnmat.markers_DGEs,"./v2_results/only_tip_seuratnmat.markers_DGEs.csv")
...
HLH_T1_OFF_HIGH_GO <- compareCluster(geneCluster = gcSampl, fun = "enrichGO",OrgDb="org.Mm.eg.db",keyType = "ENTREZID", ont = "BP",readable = TRUE,
    minGSSize = 5)
mcsaveRDS(HLH_T1_OFF_HIGH_GO,file="./new_seurat/only_tip_GO_BP_nmat.rds",mc.cores=20) 
HLH_T1_OFF_HIGH_GO <- mcreadRDS(file="./new_seurat/only_tip_GO_BP_nmat.rds",mc.cores=20) 
write.csv(HLH_T1_OFF_HIGH_GO,"./v2_results/only_tip_GO_BP_nmat.csv")
...
ggsave("./scRNA/SCLC/metastasisi/merge_all/Figure_making/US_tippingpoint_GO_BP.svg", plot=aa,width = 6, height = 5,dpi=1080)
~~~
...
~~~R
Malignant_all <- mcreadRDS(file="./scAML_project/sc-RNAseq/mmu_10X_scRNA_Landscape_of_Malignant_all.rds",mc.cores=20)
all_data <- read.csv("./new_figure_v2/MDS_AML_ALL.markers.csv")
GAL_LEUKEMIC_STEM_CELL_UP <- read.csv(file="./GAL_LEUKEMIC_STEM_CELL_UP.csv")
...
library(URD)
axial.tree_fixed <- mcreadRDS("./scAML_project/sc-RNAseq/mmu_10X_scRNA_Landscape_of_Malignant_urd_fixed.rds",mc.cores=20)
...
~~~r
Malignant3_only_inT3 <- mcreadRDS(file="./scAML_project/sc-RNAseq/mmu_10X_scRNA_Landscape_of_leukemogenesis_Malignant_at_T3.rds")
...
write.csv(Malignant3_only_inT3.markers,"./v2_results/Malignant3_only_inT3.markers.csv")
...
~~~R
TCGA_LAML <- read.csv("./DATABASE/ALL_TCGA_DATA/RNA/FPKM/TCGA/TCGA-LAML_RNA_expr.csv")
...
TCGA_LAML_clinical <- read.csv("./DATABASE/ALL_TCGA_DATA/clinical_info/ALL_info_includ_RNA_DNA/TCGA/TCGA-LAML_clinical.csv")
...
Malignant3_only_inT3.markers <- read.csv("./v2_results/Malignant3_only_inT3.markers.csv")
...
ggsave("./new_figure_v2/new_figure/TCGA_LAML_clu_Hsp90aa1_coxl.svg", plot=aa,width = 6, height = 5,dpi=1080)
~~~
...
ggtheme = theme_bw(),
risk.table=TRUE)
ggsave("./new_figure_v2/new_figure/TCGA_LAML_clu_Hsp90aa1_survival.svg", plot=aa$plot,width = 6, height = 5,dpi=1080)
~~~
...
write.csv(nmat_only_T3.markers,"./v2_results/nmat_only_T3.markers.csv")

nmat_only_T3.markers <- read.csv("./v2_results/nmat_only_T3.markers.csv")
...
write.csv(HLH_T1_OFF_HIGH_GO,"./v2_results/Malignant3_only_inT3_GO_BP_nmat.csv")
...
ggsave("./new_figure_v2/new_figure/Malignant3_only_inT3_GO_BP_nmat_GO_BP.svg", plot=aa,width = 6, height = 5,dpi=1080)
~~~
...
human_AML <- mcreadRDS("./scAML_project/sc-RNAseq/hsa_10X_scRNA_Landscape_of_leukemogenesis_all.rds",mc.cores=20)
...
ggsave("./new_figure_v2/new_figure/human_AML_tsne_by_group.png", plot=p1,width = 6, height = 5,dpi=1080)
~~~
...
ggsave("./new_figure_v2/new_figure/cluster_tree_mmu_hsa.svg", plot=aa,width = 20, height = 5,dpi=1080)
~~~
...
~~~R
smartseq2_scRNA <- mcreadRDS(file="./scAML_project/sc-RNAseq/mmu_smartseq2_scRNA_Landscape_of_leukemogenesis.rds",mc.cores=20)
...
smartseq2_scRNA_unspl <- mcreadRDS("./scAML_project/sc-RNAseq/mmu_smartseq2_scRNA_Landscape_of_leukemogenesis_unspliced.rds", mc.cores=20)
...
ggsave("./new_figure_v2/new_figure/US_Global_smartseq2_summary.svg", plot=plot,width = 6, height = 5,dpi=1080)
~~~
